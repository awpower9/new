...
# --- Custom CSS for a centered cosmic theme ---
st.markdown("""
    <style>
        .stApp {
        ...
        .rocket-animation {
            font-size: 3rem;
            margin: 1rem 0;
            animation: blast-off 2s ease-out;
        }
        @keyframes blast-off {
...
with st.container():
    ...
    # --- Title and Prompt ---
    st.markdown("<h1>🚀 SciFi Story Generator</h1>", unsafe_allow_html=True)
    st.markdown("<p style='font-size:18px; margin-bottom: 2rem;'>Fuel your imagination with a cosmic tale</p>", unsafe_allow_html=True)
    ...
    if st.button("Generate Story", type="primary"):
        if user_prompt.strip() == "":
            ...
            with st.spinner('Warp core initializing...'):
                ...
                **Cosmic Log - Stardate {datetime.now().strftime('%Y%m%d')}**
                ...
                # Rocket animation
                st.markdown("<div class='rocket-animation'>🚀</div>", unsafe_allow_html=True)
